function OOI = ExtractOOIsProj3(X, Y, intens, use_circle_fit, r_C, angles_C)
    ...
    while ~finished
        [Success, finished, Centers, Diameters, p_c, intensities_c, next_idx] = ...
                                       extractClusterProj3(X_, Y_, intens, ...
                                        use_circle_fit, r_C, angles_C);
        ...
        if Success
            ...
            OOI.angle_measurement = [OOI.angle_measurement; ...
                                                    angle_measurement];
            OOI.range_measurement = [OOI.range_measurement; ...
                                                    range_measurement];
